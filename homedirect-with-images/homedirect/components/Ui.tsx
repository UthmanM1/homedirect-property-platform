...
export function PropertyCard({p}:{p:typeof properties[number]}){
 return <article className="card overflow-hidden">
  <div className="relative aspect-[3/2] w-full"><Image src={p.images[0].src} alt={p.images[0].alt} fill sizes="(min-width:1024px) 384px,(min-width:768px) 50vw,100vw" className="object-cover"/></div>
