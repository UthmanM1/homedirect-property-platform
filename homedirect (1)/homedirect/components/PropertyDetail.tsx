...
export default function PropertyDetail({slug}:{slug:string}){
 ...
 return <div className="mx-auto max-w-6xl px-5 py-12">
  <div className="grid grid-cols-3 gap-2"><img src="/house.svg" alt={`Front of ${p.title}`} className="col-span-3 w-full rounded-xl sm:col-span-2 sm:row-span-2"/>
   <img src="/house.svg" alt="Living room" className="hidden rounded-xl sm:block"/><img src="/house.svg" alt="Garden" className="hidden rounded-xl sm:block"/></div>
